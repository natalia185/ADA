...
Bazując na p-wartość, która wyniosła `r fisher.test(t4d, workspace = 271020)$p.value` nie ma podstw do odrzucenia hipotezy o niezależności zadowolenia z wynagrodzenia od wieku.
