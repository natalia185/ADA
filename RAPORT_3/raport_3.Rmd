...
* $[1\:3]$ zmienne ,,S'' i ,,W1'' mają dowolne rozkłady oraz zmienne te są niezależne, a zmienna ,,Wyk'' ma rozkład równomierny
...
* $[13]$ zmienne ,,S'' i ,,W1'' mają dowolne rozkłady oraz zmienne te nie są niezależne, a zmienna ,,Wyk'' ma rozkład równomierny
```{r}
model_b <- glm(Freq ~ S + Wyk + S*Wyk, 
               data = df, family = poisson)
p_b <- 1-pchisq(deviance(model_b), df = df.residual(model_b))
cbind(model_a$data, fitted(model_b))
```
...
* $[1\:2\:3]$ zmienne ,,S'', ,,W1'', ''Wyk'' są wzajemnie niezależne
