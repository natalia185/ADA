...
\begin{table}[h]
		\begin{center}
			\begin{tabular}{|c|c|c|c|c|c|c|}
				...
				& $[1\:3]$ & $[13]$ & $[1\:2\:3]$ & $[12\:3]$ & $[12\:13]$ & $[1\:23]$ \\\hline
				`r model_a$data$Freq[1]` & `r fitted(model_a)[1]` & `r fitted(model_b)[1]` & `r fitted(model_c)[1]` & `r fitted(model_d)[1]` & `r fitted(model_e)[1]` & `r fitted(model_f)[1]` \\\hline
				`r model_a$data$Freq[2]` & `r fitted(model_a)[2]` & `r fitted(model_b)[2]` & `r fitted(model_c)[2]` & `r fitted(model_d)[2]` & `r fitted(model_e)[2]` & `r fitted(model_f)[2]` \\\hline
				`r model_a$data$Freq[3]` & `r fitted(model_a)[3]` & `r fitted(model_b)[3]` & `r fitted(model_c)[3]` & `r fitted(model_d)[3]` & `r fitted(model_e)[3]` & `r fitted(model_f)[3]` \\\hline
				`r model_a$data$Freq[4]` & `r fitted(model_a)[4]` & `r fitted(model_b)[4]` & `r fitted(model_c)[4]` & `r fitted(model_d)[4]` & `r fitted(model_e)[4]` & `r fitted(model_f)[4]` \\\hline
				`r model_a$data$Freq[5]` & `r fitted(model_a)[5]` & `r fitted(model_b)[5]` & `r fitted(model_c)[5]` & `r fitted(model_d)[5]` & `r fitted(model_e)[5]` & `r fitted(model_f)[5]` \\\hline
				`r model_a$data$Freq[6]` & `r fitted(model_a)[6]` & `r fitted(model_b)[6]` & `r fitted(model_c)[6]` & `r fitted(model_d)[6]` & `r fitted(model_e)[6]` & `r fitted(model_f)[6]` \\\hline
			\end{tabular}
		\end{center}
...
W tym zadaniu będziemy testować hipotezy zerowe przeciwko dwóm pewnym modelom, w których jeden jest pełny (zawieraja wszystkie interakcje) a drugi jest nadmodelem modelu z hipotezy zerowej, ale nie jest modelem pełnym. Hipotezy testujemy na poziomie istotności $\alpha = 0.05$.
...
Prawdopodobieństwo dla pierwszej z hipotez alternatywnych `r p_1` oraz dla drugiej `r p_2` są mniejsze niż założony poziom istotności $\alpha$, więc odrzucamy hipotę zerową.


* $H_0$: Dane pochodzą z modelu $[2\:13]$ 
przeciwko 
- $H_1$: Dane pochodzą z modelu $[123]$
- $H_1$: Dane pochodzą z modelu $[12\: 13]$

```{r}
m_0 <- glm(Freq ~ S+W1+Wyk+ S*Wyk, data = df_W1, family = poisson)
m_1 <- glm(Freq ~ S+W1+Wyk+S*W1+Wyk*W1+S*Wyk+S*W1*Wyk, data = df_W1, family = poisson)
m_2 <- glm(Freq ~ S+W1+Wyk+S*W1+S*Wyk, data = df_W1, family = poisson)
...
p_2 <- 1-pchisq(test$Deviance[2], df = test$Df[2])
```
Prawdopodobieństwo dla pierwszej z hipotez alternatywnych `r p_1` oraz dla drugiej `r p_2` jest mniejszy niż założony poziom istotności $\alpha$, więc odrzucamy hipotę zerową.
