...
ggplot(daneW1, aes(x=W1, y=n)) + 
    ...
    ggtitle("Wykres słupkowy dla oceny wykształcenia przed wyjazdem") + xlab('Ocena wynagrodzenia przed wyjazdem') + ylab('ilość')
```
...
ggplot(daneW2, aes(x=W2, y=n)) + 
    geom_bar(stat = "identity", fill="hotpink") + 
    ggtitle("Wykres słupkowy dla oceny wykształcenia po wyjeździe")+ xlab('Ocena wynagrodzenia po wyjeździe') + ylab('ilość')
```
