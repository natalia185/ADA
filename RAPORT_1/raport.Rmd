...
# Na razie zostawiam bo pierdolca dostaję
```
```{r}
...
```{r}
ggplot() + geom_line(aes(x=cp30$p, y=cp30$pokrycie), color='purple') + 
  geom_line(aes(x=w30$p, y=w30$pokrycie), color='hotpink') +
  geom_line(aes(x=b30$p, y=b30$pokrycie), color='darkblue') +
  labs(title = 'Procent pokrycia dla n = 30', y ='% pokrycia', x = 'p') + 
  geom_hline(yintercept = 0.95, linetype = 'dashed')
```

```{r}
ggplot() + geom_line(aes(x=cp100$p, y=cp100$pokrycie), color='purple') + 
  geom_line(aes(x=w100$p, y=w100$pokrycie), color='hotpink') +
  geom_line(aes(x=b100$p, y=b100$pokrycie), color='darkblue') +
  labs(title = 'Procent pokrycia dla n = 100', y ='% pokrycia', x = 'p') + 
  geom_hline(yintercept = 0.95, linetype = 'dashed')
```

```{r}
ggplot() + geom_line(aes(x=cp1000$p, y=cp1000$pokrycie), color='purple') + 
  geom_line(aes(x=w1000$p, y=w1000$pokrycie), color='hotpink') +
  geom_line(aes(x=b1000$p, y=b1000$pokrycie), color='darkblue') +
