...
kable(structable(W1~P, personel) %>% addmargins(),
      caption="Tablica wielodzielcza uzwlgędniająca zmienną W1 i P.") %>% 
...
```{r, results='asis'}
kable(structable(W1~S, personel) %>% addmargins(), caption="Tablica wielodzielcza uzwlgędniająca zmienną W1 i S.") %>% 
    column_spec(1, border_left = TRUE) %>%
    column_spec(6, border_right = TRUE)
```

```{r, results='asis'}
kable(structable(A1~D, personel) %>% addmargins(), caption="Tablica wielodzielcza uzwlgędniająca zmienną A1 i D.") %>% 
    column_spec(1, border_left = TRUE) %>%
